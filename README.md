...
Until _Colorful Heading Underlines_ is [made available](https://github.com/obsidianmd/obsidian-releases/pull/8820) in the plugin directory, to install it:
...
2. [Install via BRAT](https://churnish.github.io/http-protocol-redirector?r=obsidian://brat?plugin=churnish/colorful-heading-underlines).
3. Select **Add plugin**.
